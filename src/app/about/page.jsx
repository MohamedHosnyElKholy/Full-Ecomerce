    ...
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-6">
        {[
          ...
          <div
            key={index}
            className="flex flex-col items-center p-4 bg-gray-800 border-2 border-gray-300 rounded-lg max-w-xs mx-auto my-3"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-6">
        {[
          ...
          <div
            key={index}
            className="flex flex-col items-center p-4 border-2 border-gray-300 rounded-lg max-w-xs mx-auto my-3"
          >
            <Image
              src={image}
              alt={name}
